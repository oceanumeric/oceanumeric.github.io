...
[1] [DevTools Snippets](http://bgrins.github.io/devtools-snippets/#console-save)<br>
[2] [Web APIs Blob](https://developer.mozilla.org/en-US/docs/Web/API/Blob)<br>
[3] [Scraping XHR](https://scrapism.lav.io/scraping-xhr/)<br>
