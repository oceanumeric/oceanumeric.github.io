...
0 \\ 1 \\ 4 \\ 9
\end{bmatrix}  \quad \text{element-wise multiplication} 
\end{aligned} \tag{1}
$$
...
$$
\begin{aligned}
\frac{\partial y_1}{\partial x} &= 2x  = \begin{bmatrix} 0 \\ 2 \\ 4 \\ 6  \end{bmatrix} \\
\frac{\partial y_2}{\partial x} &= 2x = \begin{bmatrix} 0 \\ 4 \\ 4 \\ 6  \end{bmatrix} \\
\end{aligned} \tag{2}
$$
