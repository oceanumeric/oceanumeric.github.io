...
<div class='figure'>
    <img src="/images/blog/github-q1-histotry.png"
         alt="github q1 history" class="zoom-img"
         style="width: 76%; display: block; margin: 0 auto;"/>
    <div class='caption'>
        <span class='caption-label'>Figure 1.</span> My Github commit history for Q1 2023.
    </div>
</div>
...
- In 2013, a paper called _Distributed representations of words and phrases and their compositionality_ was published by Tomas Mikolov et al {% cite mikolov2013distributed %}
- In 2017, another paper called _Attention is all you need_ was published by Ashish Vaswani et al {% cite vaswani2017attention %}
- In 2023, literally, everyone is talking about ChatGPT. 


<div class='figure'>
    <img src="/images/blog/models-colorgrey.jpg"
         alt="github q1 history" class="zoom-img"
         style="width: 76%; display: block; margin: 0 auto;"/>
    <div class='caption'>
        <span class='caption-label'>Figure 2.</span> The evolutional tree of Language Models (from [Github: Mooler0410/LLMsPracticalGuide])
    </div>
</div>
...
<div align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/7XqQZf09O-U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
<div align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/5o17htMVZ9g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
<div align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/9q7G3uQANn4?start=200" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
...
- for ambitious people, they tend to have a strong sense of self-identity and self-esteem, therefore, one should not try to change their mind, but to inspire them to follow you
- for people who are not very ambitious, they need to have a strong sense of belonging, therefore, one should not try to inspire them, but to make them feel that they belong to the group with money and profit
- for people who are below average, they need to have a strong sense of security and stability, so, feed them with that. 
...
| :--- | --- | --- |
| __High Productivity__ | invest in property | invest in stocks, etc. |
| __Low Productivity__ | invest in commodity, gold, etc. | invest in bonds |

For more discussion on this topic, please refer to the following video:

<div align="center">
<iframe width="560" height="315" src="https://www.youtube.com/embed/GDuXvOs0d_k?start=1327" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
